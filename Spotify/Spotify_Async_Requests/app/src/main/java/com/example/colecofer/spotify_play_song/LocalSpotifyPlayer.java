...
public class LocalSpotifyPlayer extends AppCompatActivity implements Player.NotificationCallback, ConnectionStateCallback {
    ...
    public void onCreate() {
        //Gather references to UI elements here
        //updateView();
        ...
        if (player == null) {
            ...
            player = Spotify.getPlayer(playerConfig, this, new SpotifyPlayer.InitializationObserver() {
                ...
                public void onInitialized(SpotifyPlayer player) {
                    ...
                    player.setConnectivityStatus(OperationCallback, getNetworkConnectivity(LocalSpotifyPlayer.this));
                    player.addNotificationCallback(LocalSpotifyPlayer.this);
                    player.addConnectionStateCallback(LocalSpotifyPlayer.this);
                    // Trigger UI refresh
                    updateView();
                }
